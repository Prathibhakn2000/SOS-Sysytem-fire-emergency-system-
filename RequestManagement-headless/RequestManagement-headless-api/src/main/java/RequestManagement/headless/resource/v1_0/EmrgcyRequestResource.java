package RequestManagement.headless.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/RequestManagement-headless/v1.0
 *
 * @author prath
 * @generated
 */
@Generated("")
@ProviderType
public interface EmrgcyRequestResource {
	...
	public EmrgcyRequest patchEmrgcyRequest(
			Long requestId, EmrgcyRequest emrgcyRequest)
		throws Exception;
	...
	public Response deleteEmrgcyRequestBatch(
			Long requestId, String callbackURL, Object object)
		throws Exception;
