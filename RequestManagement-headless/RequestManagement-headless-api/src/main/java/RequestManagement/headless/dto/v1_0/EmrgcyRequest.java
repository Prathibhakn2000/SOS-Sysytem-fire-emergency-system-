package RequestManagement.headless.dto.v1_0;
...
@Generated("")
@GraphQLName(
	description = "Represent emergency request APIs.", value = "EmrgcyRequest"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EmrgcyRequest")
public class EmrgcyRequest implements Serializable {

	public static EmrgcyRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(EmrgcyRequest.class, json);
	}

	public static EmrgcyRequest unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EmrgcyRequest.class, json);
	}
	...
	public void setAssignedTeam(
		UnsafeSupplier<String, Exception> assignedTeamUnsafeSupplier) {

		try {
			assignedTeam = assignedTeamUnsafeSupplier.get();
		}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), emrgcyRequest.toString());
	}
	...
	public String toString() {
		...
		if (assignedTeam != null) {
			...
			sb.append(_escape(assignedTeam));
	...
	@Schema(
		...
		defaultValue = "RequestManagement.headless.dto.v1_0.EmrgcyRequest",
		name = "x-class-name"
	)
