package TicketMgmtHeadlessAPI.internal.graphql.query.v1_0;
...
public class Query {
	 ...
	 */
	@GraphQLField(description = "Retrieve all booked tickets.")
	public TicketMgmtPage tickets() throws Exception {
		return _applyComponentServiceObjects(
			_ticketMgmtResourceComponentServiceObjects,
			this::_populateResourceContext,
			ticketMgmtResource -> new TicketMgmtPage(
				ticketMgmtResource.getTickets()));
	}

	@GraphQLName("TicketMgmtPage")
	public class TicketMgmtPage {

		public TicketMgmtPage(Page ticketMgmtPage) {
			actions = ticketMgmtPage.getActions();

			items = ticketMgmtPage.getItems();
			lastPage = ticketMgmtPage.getLastPage();
			page = ticketMgmtPage.getPage();
			pageSize = ticketMgmtPage.getPageSize();
			totalCount = ticketMgmtPage.getTotalCount();
		}
		...
		@GraphQLField
		protected java.util.Collection<TicketMgmt> items;
