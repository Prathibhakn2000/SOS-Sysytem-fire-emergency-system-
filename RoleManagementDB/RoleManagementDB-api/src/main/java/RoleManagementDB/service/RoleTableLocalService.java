...
/**
 * Provides the local service interface for RoleTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RoleTableLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RoleTableLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>RoleManagementDB.service.impl.RoleTableLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the role table local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RoleTableLocalServiceUtil} if injection and service tracking are not available.
	 */
