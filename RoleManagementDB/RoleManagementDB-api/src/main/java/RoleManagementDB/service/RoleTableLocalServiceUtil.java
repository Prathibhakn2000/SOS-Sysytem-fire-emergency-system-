...
/**
 * Provides the local service utility for RoleTable. This utility wraps
 * <code>RoleManagementDB.service.impl.RoleTableLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RoleTableLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>RoleManagementDB.service.impl.RoleTableLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RoleTable addRoleTable(RoleTable roleTable) {
		return getService().addRoleTable(roleTable);
	}
	 ...
	 */
	public static RoleTable createRoleTable(long roleId) {
		return getService().createRoleTable(roleId);
	}
	 ...
	 */
	public static RoleTable deleteRoleTable(long roleId)
		throws PortalException {

		return getService().deleteRoleTable(roleId);
	}
	 ...
	 * @return the role table that was removed
	 */
	public static RoleTable deleteRoleTable(RoleTable roleTable) {
		return getService().deleteRoleTable(roleTable);
	}
	...
	public static RoleTable fetchRoleTable(long roleId) {
		return getService().fetchRoleTable(roleId);
	}
	 ...
	 */
	public static RoleTable fetchRoleTableByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchRoleTableByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a role table with the primary key could not be found
	 */
	public static RoleTable getRoleTable(long roleId) throws PortalException {
		return getService().getRoleTable(roleId);
	}
	 ...
	 */
	public static RoleTable getRoleTableByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getRoleTableByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<RoleTable> getRoleTables(int start, int end) {
		return getService().getRoleTables(start, end);
	}
	 ...
	 */
	public static List<RoleTable> getRoleTablesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getRoleTablesByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<RoleTable> getRoleTablesByUuidAndCompanyId(
		...
		return getService().getRoleTablesByUuidAndCompanyId(
	 ...
	 */
	public static int getRoleTablesCount() {
		return getService().getRoleTablesCount();
	}
	 ...
	 */
	public static RoleTable updateRoleTable(RoleTable roleTable) {
		return getService().updateRoleTable(roleTable);
	}

	public static RoleTableLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RoleTableLocalService> _serviceSnapshot =
		new Snapshot<>(
			RoleTableLocalServiceUtil.class, RoleTableLocalService.class);
